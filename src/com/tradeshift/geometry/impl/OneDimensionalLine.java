...
public abstract class OneDimensionalLine implements
	...
	public OneDimensionalLine()
	{
		dimensions = Dimension.OneDimensionalLine ;
		addGeometricDetails("Dimension- Data", dimensions.getValue() + " Dimensional Object...");
	}
	
	public OneDimensionalLine(int dime, ArrayList <Double> listOfSides)
	{
		this(listOfSides) ;
	...
	public OneDimensionalLine(ArrayList <Double> listOfSides)
	{
		this();		
		sides = listOfSides ;
		if ((sides != null) && (sides.size() > 0))
			addGeometricDetails("Sides Data", "This is a " + sides.size() +  " sided Line..." );
	}
